...
parser.add_argument('--Name' , type=str  , default='AS_')
...
#Sequential
parser.add_argument('--Seq_train'    , type=bool , default=False)
#VP-VV
...
Details=f'{args.Name}_{args.Network_type}_Eqn:{args.Eqn}_RBA-R:{args.use_RBA}-Seq:{args.Seq_train}'
