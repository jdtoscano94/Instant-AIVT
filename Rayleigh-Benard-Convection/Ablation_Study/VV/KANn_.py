...
parser.add_argument('--use_RBA'    , type=bool , default=False)
parser.add_argument('--k_samp' , type=float  , default=0.0)
...
Details=f'{args.Name}_{args.Network_type}_n:{num_layer}_H:{width_layer}_K:{args.degree}_RBA:{args.use_RBA}_k_samp:{args.k_samp}'
